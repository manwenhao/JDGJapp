...
public class OnGoingTaskActivity extends AppCompatActivity {
    ...
    private static final String TAG = "OnGoingTaskActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv = (ListView) findViewById(R.id.lv_on_going_task);
        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(OnGoingTaskActivity.this, MainActivity.class);
                intent.putExtra("id",2);
                startActivity(intent);
            }
        });
        List<Map<String, Object>> list = getData();
        lv.setAdapter(new Task_ListViewAdapter(OnGoingTaskActivity.this, list));
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Log.d(TAG, taskid);
                Intent intent = new Intent(OnGoingTaskActivity.this,OnGoingTaskInfoActivity.class);
