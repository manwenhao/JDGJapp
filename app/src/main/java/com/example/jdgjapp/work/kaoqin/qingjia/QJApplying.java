...
public class QJApplying extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qjapplying);
        listView=(ListView)findViewById(R.id.qj_applying_listview);
                ...
                OkHttpUtils.post()
                        ...
                        .execute(new StringCallback() {
                            ...
                            public void onResponse(String response, int id) {
                                ...
                                aCache.put("qjapplying",datestring);
                                ...
                                public void onResponse(String response, int id) {
                                    ...
                                    runOnUiThread(new Runnable() {
                                        ...
                                        public void run() {
                                            ...
                                            Toast.makeText(MyApplication.getContext(), "请假申请结果刷新", Toast.LENGTH_SHORT).show();
                                            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                                @Override
                                                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                                                    Intent intent=new Intent(MyApplication.getContext(),QJApplyDetail.class);
