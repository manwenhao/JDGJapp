...
public class NotReceivedTaskActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_not_received_task);
        backBtn = (Button) findViewById(R.id.btn_back);
        lv = (ListView) findViewById(R.id.lv_not_received_task);
        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(NotReceivedTaskActivity.this, MainActivity.class);
                intent.putExtra("id",2);
                startActivity(intent);
            }
        });
        List<Map<String, Object>> list = getData();
        lv.setAdapter(new Task_ListViewAdapter(NotReceivedTaskActivity.this, list));
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Log.d(TAG, taskid);
                Intent intent = new Intent(NotReceivedTaskActivity.this,NotReceivedTaskInfoActivity.class);
