...
public class CCApplyrefuse extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ccapplyrefuse);
        listView=(ListView)findViewById(R.id.cc_applyrefuse_listview);
                ...
                OkHttpUtils.post()
                        ...
                        .execute(new StringCallback() {
                            ...
                            public void onResponse(String response, int id) {
                                ...
                                aCache.put("ccapplyrefuse",datestring);
                                ...
                                public void onResponse(String response, int id) {
                                    ...
                                    runOnUiThread(new Runnable() {
                                        ...
                                        public void run() {
                                            ...
                                            Toast.makeText(MyApplication.getContext(), "出差审批结果刷新，你有出差申请未通过", Toast.LENGTH_SHORT).show();
                                            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                                @Override
                                                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                                                    Intent intent=new Intent(MyApplication.getContext(),CCApplyDetail.class);
