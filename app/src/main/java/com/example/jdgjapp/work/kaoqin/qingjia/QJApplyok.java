...
public class QJApplyok extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qjapplyok);
        listView=(ListView)findViewById(R.id.qj_applyok_listview);
                ...
                OkHttpUtils.post()
                        ...
                        .execute(new StringCallback() {
                            ...
                            public void onResponse(String response, int id) {
                                ...
                                aCache.put("qjapplyok",datestring);
                                ...
                                public void onResponse(String response, int id) {
                                    ...
                                    runOnUiThread(new Runnable() {
                                        ...
                                        public void run() {
                                            ...
                                            Toast.makeText(MyApplication.getContext(), "请假审批结果刷新，你有请假申请通过", Toast.LENGTH_SHORT).show();
                                            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                                @Override
                                                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                                                    Intent intent=new Intent(MyApplication.getContext(),QJApplyDetail.class);
