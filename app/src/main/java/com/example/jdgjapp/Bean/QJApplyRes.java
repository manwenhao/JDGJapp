...
public class QJApplyRes implements Serializable{
   private String id;
   ...
   private String type;
    ...
    public QJApplyRes(String id, String man_id, String datime, String startdate, String enddate, String reason, String answer, String ansreason, String type) {
        this.id = id;
        this.man_id = man_id;
        this.datime = datime;
